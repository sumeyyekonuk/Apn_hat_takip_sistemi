...
function HatTahsisForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <label>
        <input type="radio" name="billing_type" value="aylik" checked={form.billing_type === 'aylik'} onChange={handleChange} /> Aylık
      </label>
      <label>
        <input type="radio" name="billing_type" value="yillik" checked={form.billing_type === 'yillik'} onChange={handleChange} /> Yıllık
      </label>
